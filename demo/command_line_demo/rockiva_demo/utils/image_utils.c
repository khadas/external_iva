...
void DrawRectangleRGB(unsigned char* pixels, int w, int h, int rx, int ry, int rw, int rh, unsigned char color[3],
                      int thickness)
{
    int stride = w * 3;
...
void DrawLineRGB(unsigned char* pixels, int w, int h, int x0, int y0, int x1, int y1, unsigned char color[3], int thickness)
{
    int stride = w * 3;
...
void DrawTextRGB(unsigned char* pixels, int w, int h, const char* text, int x, int y, int fontpixelsize, unsigned char color[3])
{
    int stride = w * 3;
